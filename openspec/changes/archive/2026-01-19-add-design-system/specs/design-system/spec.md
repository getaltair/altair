...
The Altair Design System provides consistent, accessible UI components across all platforms using Compose Unstyled primitives (for buttons) and Compose Foundation primitives (for other components) with custom styling.
