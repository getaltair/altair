---
description: Run all pre-commit quality checks and fix any issues found
---
...
**Repeat the run and fix steps iteratively** until `./gradlew check` passes with a clean exit status (exit code 0).
