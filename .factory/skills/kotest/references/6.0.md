...
**URL:** https://kotest.io/docs/6.0/intellij/intellij-test-explorer.html
...
**URL:** https://kotest.io/docs/release6
...
**URL:** https://kotest.io/docs/6.0/blogs
...
**URL:** https://kotest.io/docs/6.0/intellij/intellij-plugin.html
...
**URL:** https://kotest.io/docs/6.0/quickstart
...
View the assertions documentation for more information.
...
Example 4 (kotlin):
```kotlin
kotlin {   targets {      js {         browser()         nodejs()      }   }   sourceSets {      val jsTest by getting {         dependencies {            implementation("io.kotest:kotest-assertions-core:$version")         }      }   }}
```
...
**URL:** https://kotest.io/docs/6.0/changelog.html
...
**URL:** https://kotest.io/docs/6.0/release6
...
**URL:** https://kotest.io/docs/6.0/intellij/intellij-properties.html
