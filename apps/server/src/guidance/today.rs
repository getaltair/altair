...
/// Today's overview: due/overdue quests, active routines, and today's check-in.
...
/// Get the "today" dashboard: pending/in-progress quests due today or overdue
/// (past due date), quests without a due date, active routines, and today's
/// check-in.
pub async fn handler(
    ...
    let (quests, routines, checkin) = tokio::try_join!(
        // Quests: pending or in_progress, due today/overdue or no due date
        async {
