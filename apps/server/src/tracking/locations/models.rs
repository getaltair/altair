...
/// Database-backed tracking location record
...
/// Request payload for creating a new tracking location
...
/// Request payload for updating an existing tracking location.
///
