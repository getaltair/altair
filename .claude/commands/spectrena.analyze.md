...
if [ -d ".spectrena/templates" ]; then
    echo ""
    echo ".spectrena.spectrena/templates/"
    ls -la .spectrena.spectrena/templates/ 2>/dev/null | tail -n +2
fi

if [ -d ".spectrena/memory" ]; then
    echo ""
    echo ".spectrena.spectrena/memory/"
    ls -la .spectrena.spectrena/memory/ 2>/dev/null | tail -n +2
fi
```
