...
1. Check if `.spectrena.spectrena/memory/constitution.md` exists
2. If not, ask about:
...
4. Write to `.spectrena.spectrena/memory/constitution.md`
5. **Git: Commit:**
   ```bash
   git add .spectrena.spectrena/memory/constitution.md
   git commit -m "docs: Establish project constitution"
   ```

## Output

Creates `.spectrena.spectrena/memory/constitution.md`:
...
Created .spectrena.spectrena/memory/constitution.md
```
